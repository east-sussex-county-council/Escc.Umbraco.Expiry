...
DisableAnonymousAuthentication $projectName
EnableWindowsAuthentication $projectName
CopyConfig "$projectName\Web.example.config" "$projectName\web.config"

CopyConfig "Escc.Umbraco.Expiry.Notifier\app.example.config" "Escc.Umbraco.Expiry.Notifier\app.config"
